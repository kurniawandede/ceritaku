<style>
    .nav-item a[href="<?php echo base_url(); ?>profile/ceritamu"] {
...
<section>
<div class="mine-color" style="margin-bottom: 0;">
  <div style="width: 100%; height: 7vh; display: flex; align-items: center; justify-content: center;">
    <h3 class="container text-light" style="margin: 0;">Kak <span><?php echo $this->session->userdata('fullname') ?>, Ini Daftar Cerita yang kamu tulis</span></h3>
                    ...
                    <div class="card" style="width: 15rem;box-shadow: 6px 5px 20px 0px rgba(0,0,0,0.75);">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">Penulis : <span class="f-color fw-bold"><?php echo $c['fullname']; ?></span></p>
                          ...
                          </svg><span style="margin-top: 2%;" class="m-2 fw-bold"><?php echo $c['rating']; ?></span>
<!--                           
